...
export type DashboardTarget =
  | { view: "sales"; target: "new-sale" | "sales-today" | "sales-month" | "payments-today" | "customer-dues"; shopDate?: string }
  | { view: "sales"; target: "sale"; id: number }
  | { view: "sales"; target: "payment"; customerId: number }
  | { view: "purchases"; target: "payables" }
  | { view: "fulfilment"; target: "deliveries" | "damage" }
