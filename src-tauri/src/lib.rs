...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::suppliers::supplier_delete,
            ...
            commands::purchases::purchase_delete,
            ...
            commands::sales::customer_delete,
            ...
            commands::sales::sale_edit,
            commands::sales::sale_delete,
            commands::sales::sale_draft_delete,
            ...
            commands::fulfilment::delivery_delete,
